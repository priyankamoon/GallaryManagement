...
def requests_logger():
    ...
    """
    return init_logging(log_name='API_LOGS')
...
def user_logger():
    ...
    """
    return init_logging(log_name='USER_LOGS')
...
def request_data_post_logger():
    ...
    """
    return init_logging(log_name='REQ_POST_LOGS')



def excel_logs():

    return init_logging(log_name='EXCEL_LOGS')
